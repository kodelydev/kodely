	...
	*/
	...
	async getStateToPostToWebview() {
		...
		return {
			...
			allowedCommands,
			allowedCommandsExceptions: vscode.workspace.getConfiguration("kodely").get<string[]>("allowedCommandsExceptions") || [],
	...
	async getState() {
		...
		return {
			...
			allowedCommandsExceptions: stateValues.allowedCommandsExceptions,
